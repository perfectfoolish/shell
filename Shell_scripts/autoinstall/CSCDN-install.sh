...
DAHDI_LINUX_SOURCE_DIR=$DAHDI_LINUX_DFLT_INSTALL_DIR   #"/usr/src/dahdi-linux/"
DAHDI_TOOLS_SOURCE_DIR=$DAHDI_TOOLS_DFLT_INSTALL_DIR   #"/usr/src/dahdi-tools/"
DAHDI_LINUX_COMPLETE_SOURCE_DIR=$DAHDI_LINUX_COMPLETE_DFLT_INSTALL_DIR	#"/usr/src/dahdi-linux-complete"
AST_SOURCE_DIR=$AST_DFLT_INSTALL_DIR  	#"/usr/src/asterisk/"

DAHDI_AUTO_INSTALL="YES"
AST_AUTO_INSTALL="YES"

#ENVIRONMENT INFO  这些好像是没用，没有调用它的地方
