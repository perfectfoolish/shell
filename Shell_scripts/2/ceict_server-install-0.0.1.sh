...
add_conf()
{
	...
	if [ -f /etc/asterisk/manager.conf ]; then
		...
		cp ./ceict_server/voip_conf/manager.conf /etc/asterisk
	fi
	
	cp ./ceict_server/voip_conf/res_mysql.conf /etc/asterisk
	cp ./ceict_server/voip_conf/ptt_group_options.conf /etc/asterisk
	cp ./ceict_server/voip_conf/sip_custom.conf /etc/asterisk/
...
ip_control()
{
	cp ./ceict_server/ipdispatch_conf/extensions_dispatch.conf /etc/asterisk
	cp ./ceict_server/ipdispatch_conf/ceict_conf.sh /var/lib/asterisk/agi-bin/
	cp ./ceict_server/ipdispatch_conf/ceict_broadcast.sh /var/lib/asterisk/agi-bin/
